...
export const BorderedCard = (
  ...
  <div
    className={cn(
      'relative mx-auto w-full rounded-lg border border-dashed border-zinc-300 px-4 sm:px-6 md:px-8 dark:border-zinc-800',
      props.className,
    )}
  >
    <div className="absolute left-0 top-4 -z-0 h-px w-full bg-zinc-400 sm:top-6 md:top-8 dark:bg-zinc-700"></div>
...
export default function BlogContainer(props: {
  ...
  return (
    <Card hideLeft={true}>
      <div className="grid grid-cols-1 pt-4 md:grid-cols-5 lg:mr-10">
...
export function Contribute(props: {
  ...
  return (
    <div className={cn('space-y-2 text-sm', props.className)}>
      ...
      <ul className="space-y-2">
        ...
        {/* Enable for docs/blogs that have videos */}
        {/* <a
          className="flex cursor-pointer items-center gap-x-2 text-sm hover:underline"
          target="_blank"
          href="https://discord.gg/aj9bRtrmNt"
