...
export function createOutput(contextFn: () => Context) {
  return {
    ...
    badRequest(value?: Data | null, headers?: Record<string, string>) {
      return send(contextFn(), value, 400, headers);
    },
    unauthorized(value?: Data | null, headers?: Record<string, string>) {
      return send(contextFn(), value, 401, headers);
    },
    forbidden(value?: Data | null, headers?: Record<string, string>) {
    ...
    notImplemented(value?: Data | null, headers?: Record<string, string>) {
    ...
    unprocessableEntity(value?: Data | null, headers?: Record<string, string>) {
      return send(contextFn(), value, 422, headers);
    },
    internalServerError(value?: Data | null, headers?: Record<string, string>) {
      return send(contextFn(), value, 500, headers);
    },
    serviceUnavailable(value?: Data | null, headers?: Record<string, string>) {
