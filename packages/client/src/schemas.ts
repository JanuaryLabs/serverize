...
export default {
  "GET /container/logs": {
        ...
        toRequest(input: StreamEndpoints['GET /container/logs']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
          const endpoint = 'GET /container/logs';
            return toRequest(endpoint, input, {
            inputHeaders: [],
            inputQuery: ["projectName","channelName","releaseName","timestamp","details","tail"],
            inputBody: [],
            inputParams: [],
          }, init);
          },
  ...
  "POST /organizations/default": {
        ...
        toRequest(input: Endpoints['POST /organizations/default']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /organizations": {
        ...
        toRequest(input: Endpoints['POST /organizations']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /workspaces": {
        ...
        toRequest(input: Endpoints['POST /workspaces']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /projects": {
        ...
        toRequest(input: Endpoints['POST /projects']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "PATCH /projects/{id}": {
        ...
        toRequest(input: Endpoints['PATCH /projects/{id}']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /projects": {
        ...
        toRequest(input: Endpoints['GET /projects']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /users/organizations": {
        ...
        toRequest(input: Endpoints['GET /users/organizations']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /users/link": {
        ...
        toRequest(input: Endpoints['POST /users/link']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /users/signin": {
        ...
        toRequest(input: Endpoints['POST /users/signin']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /operations/releases/start": {
        ...
        toRequest(input: Endpoints['POST /operations/releases/start']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
          const endpoint = 'POST /operations/releases/start';
            return toRequest(endpoint, input, {
            inputHeaders: [],
            inputQuery: [],
            inputBody: ["releaseName","projectId","projectName","channel","tarLocation","runtimeConfig","port","image","volumes","serviceName","environment"],
            inputParams: [],
          }, init);
          },
        },
  "POST /operations/releases/{releaseName}/restart": {
        ...
        toRequest(input: Endpoints['POST /operations/releases/{releaseName}/restart']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /operations/channels/{channelName}/restart": {
        ...
        toRequest(input: Endpoints['POST /operations/channels/{channelName}/restart']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /operations/config": {
        ...
        toRequest(input: Endpoints['GET /operations/config']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /tokens": {
        ...
        toRequest(input: Endpoints['POST /tokens']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "DELETE /tokens": {
        ...
        toRequest(input: Endpoints['DELETE /tokens']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /tokens": {
        ...
        toRequest(input: Endpoints['GET /tokens']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /tokens/{id}": {
        ...
        toRequest(input: Endpoints['GET /tokens/{id}']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /releases": {
        ...
        toRequest(input: Endpoints['POST /releases']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "PATCH /releases/complete/{releaseId}": {
        ...
        toRequest(input: Endpoints['PATCH /releases/complete/{releaseId}']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "PATCH /releases/{releaseId}": {
        ...
        toRequest(input: Endpoints['PATCH /releases/{releaseId}']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /releases/{releaseId}/snapshots": {
        ...
        toRequest(input: Endpoints['POST /releases/{releaseId}/snapshots']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /releases": {
        ...
        toRequest(input: Endpoints['GET /releases']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
          const endpoint = 'GET /releases';
            return toRequest(endpoint, input, {
            inputHeaders: [],
            inputQuery: ["projectId","channel","status","conclusion","pageSize","pageNo"],
            inputBody: [],
            inputParams: [],
          }, init);
          },
  ...
  "DELETE /releases": {
        ...
        toRequest(input: Endpoints['DELETE /releases']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "POST /secrets": {
        ...
        toRequest(input: Endpoints['POST /secrets']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /secrets": {
        ...
        toRequest(input: Endpoints['GET /secrets']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /secrets/values": {
        ...
        toRequest(input: Endpoints['GET /secrets/values']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /root/favicon.ico": {
        ...
        toRequest(input: Endpoints['GET /root/favicon.ico']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /root": {
        ...
        toRequest(input: Endpoints['GET /root']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
  ...
  "GET /root/health": {
        ...
        toRequest(input: Endpoints['GET /root/health']['input'], init: {baseUrl:string; headers?: Record<string, string>}) {
